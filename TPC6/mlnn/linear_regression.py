...
def testdataset():
    ...
    model = LinearRegression(ds, True, regularization = True, lamda = 100)
    
    model.buildModel()
    print(model.costFunction())
    model.printCoefs()     
#    print(model.crossValidation(ds, 5))
#    print(model.resampling(ds, 10, 0.7))
    
#    model2 = LinearRegression(ds, True, regularization = False)
#    print(model2.crossValidation(ds, 5))
#    print(model2.resampling(ds, 10, 0.7))
